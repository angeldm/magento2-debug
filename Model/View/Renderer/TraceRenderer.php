...
{
    const TEMPLATE = 'Angeldm_Debug::renderer/trace.phtml';
    ...
    /**
     * @var \Angeldm\Debug\Model\View\Renderer\TraceCallRendererFactory
     */
    ...
    public function __construct(
        ...
        \Angeldm\Debug\Model\View\Renderer\TraceCallRendererFactory $traceCallRendererFactory
    ) {
        $this->id = uniqid();
        $this->trace = $trace;
        $this->layout = $layout;
