...
namespace Angeldm\Debug\Test\Unit\Plugin\PageCache;

use Angeldm\Debug\Plugin\PageCache\KernelPlugin;
...
class KernelPluginTest extends TestCase
{
    ...
    {
        $this->httpStorageMock = $this->getMockBuilder(\Angeldm\Debug\Model\Storage\HttpStorage::class)
