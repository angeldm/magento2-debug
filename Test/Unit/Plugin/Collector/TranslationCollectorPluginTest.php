...
use Angeldm\Debug\Plugin\Collector\TranslationCollectorPlugin;
...
class TranslationCollectorPluginTest extends TestCase
{
    public function testBeforeRender()
    {
        ...
        $translationCollectorMock = $this->getMockBuilder(\Angeldm\Debug\Model\Collector\TranslationCollector::class)
            ->disableOriginalConstructor()
            ->getMock();
