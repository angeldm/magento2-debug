...
use Angeldm\Debug\Plugin\Collector\ModelCollectorPlugin;
...
class ModelCollectorPluginTest extends TestCase
{
    ...
    {
        $this->modelCollectorMock = $this->getMockBuilder(\Angeldm\Debug\Model\Collector\ModelCollector::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->formatterMock = $this->getMockBuilder(\Angeldm\Debug\Helper\Formatter::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->debugMock = $this->getMockBuilder(\Angeldm\Debug\Helper\Debug::class)
            ->disableOriginalConstructor()
            ->getMock();
