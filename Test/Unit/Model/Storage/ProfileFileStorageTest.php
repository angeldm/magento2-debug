...
use Angeldm\Debug\Model\Storage\ProfileFileStorage;
...
class ProfileFileStorageTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->loggerMock = $this->getMockBuilder(\Angeldm\Debug\Logger\Logger::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->fileHelperMock = $this->getMockBuilder(\Angeldm\Debug\Helper\File::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->profileFactoryMock = $this->getMockBuilder(\Angeldm\Debug\Model\ProfileFactory::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->profileSerializerMock = $this->getMockBuilder(\Angeldm\Debug\Model\Serializer\ProfileSerializer::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->profileIndexerMock = $this->getMockBuilder(\Angeldm\Debug\Model\Indexer\ProfileIndexer::class)
            ->disableOriginalConstructor()
            ->getMock();

        $this->profileMock = $this->getMockForAbstractClass(\Angeldm\Debug\Api\Data\ProfileInterface::class);

        $this->criteriaMock = $this->getMockBuilder(\Angeldm\Debug\Model\Profile\Criteria::class)
            ->disableOriginalConstructor()
            ->getMock();
