...
namespace Angeldm\Debug\Test\Unit\Helper;

use Angeldm\Debug\Helper\Config;
use Angeldm\Debug\Model\Config\Source\ErrorHandler;
use Angeldm\Debug\Model\Storage\HttpStorage;
...
class ConfigTest extends TestCase
{
    ...
    {
        $this->expectException(\Angeldm\Debug\Exception\CollectorNotFoundException::class);
