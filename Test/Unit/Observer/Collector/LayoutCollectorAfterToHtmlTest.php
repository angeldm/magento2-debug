...
namespace Angeldm\Debug\Test\Unit\Observer\Collector;

use Angeldm\Debug\Observer\Collector\LayoutCollectorAfterToHtml;
...
class LayoutCollectorAfterToHtmlTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->layoutCollectorMock = $this->getMockBuilder(\Angeldm\Debug\Model\Collector\LayoutCollector::class)
            ->disableOriginalConstructor()
            ->getMock();
