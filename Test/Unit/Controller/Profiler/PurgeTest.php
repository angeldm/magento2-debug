...
namespace Angeldm\Debug\Test\Unit\Controller\Profiler;

use Angeldm\Debug\Controller\Profiler\Purge;
...
class PurgeTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->profileFileStorageMock = $this->getMockBuilder(\Angeldm\Debug\Model\Storage\ProfileFileStorage::class)
            ->disableOriginalConstructor()
            ->getMock();
