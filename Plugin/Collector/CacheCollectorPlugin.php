...
use Angeldm\Debug\Model\ValueObject\CacheAction;
...
{
    /**
     * @var \Angeldm\Debug\Model\Collector\CacheCollector
     */
    private $cacheCollector;

    public function __construct(
        \Angeldm\Debug\Model\Collector\CacheCollector $cacheCollector
    ) {
