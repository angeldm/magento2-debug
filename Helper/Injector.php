...
class Injector
{
    ...
    /**
     * @var \Angeldm\Debug\Model\View\Toolbar
     */
    private $viewModel;

    public function __construct(
        \Magento\Framework\View\LayoutInterface $layout,
        \Angeldm\Debug\Model\View\Toolbar $viewModel
    ) {
        $this->layout = $layout;
    ...
    public function inject(Request $request, Response $response, $token = null)
    {
        ...
        if (false !== $pos) {
            ...
            $toolbarBlock->setTemplate('Angeldm_Debug::profiler/toolbar/js.phtml')->setData([
            ...
            $jsBlock->setTemplate('Angeldm_Debug::profiler/js.phtml');
